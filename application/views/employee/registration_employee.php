<div class="container">
  <div class="row">
    <?php echo form_open('employee/logic_employee_registration_one');?>

    <div class="jumbotron"> 
      <h3 class="registration_form_header">Employee Registration Form One</h3>
    ...
    <div class="col-md-4">
      ...
      <div class="form-group ">
        ...
        <div class="form-group ">
              <select name="emp_roll" class="form-control input_form_one" id="emp_roll">
                <option value="Select_Roll">Roll</option>
   ...
   //input validation
    $(document).ready(function(){
      ...
      $('#btn_next_form_one').click(function(event){
          ...
          if(roll == 'Select_Roll'){
            $('#emp_roll').addClass('error_username');
            event.preventDefault();
          }else{
            $('#emp_roll').removeClass('error_username');
          }
      ...
      $('#emp_roll').focus(function(event){
         $('#username_div').hide();
      });

      $('#emp_fname').focus(function(event){
         $('#username_div').hide();
      });
      ...
      $('#emp_lname').focus(function(event){
         $('#username_div').hide();
      });
      ...
      $('#emp_sex').focus(function(event){
         $('#username_div').hide();
      });

      $('#emp_email').focus(function(event){
         $('#username_div').hide();
      });
